...
public class get_arbit_2 {
    ...
    public void get_region(MouseEvent e)
    {
        Pair<Integer,Integer> temp = new Pair<>(e.getPoint().x,e.getPoint().y);
...
//          fill_or_not.removeAll(temp_fill_or_not);
      ...
      public void modify_color(MouseEvent e){
          Point p=e.getPoint();
            int hfd = 50000;
        //    p.y=-1*p.y;
            for(int i=0;i<Regions.size();i++){
